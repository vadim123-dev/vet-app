...
(UNHEX('112233445566778899AABBCC00000001'), 'vad',   'Vadim', 'Hasmenik',  1, 'Beit Dagan',    '0523434834', '$2b$12$abcdefghijklmnopqrstuvwxyz'),
(UNHEX('112233445566778899AABBCC00000002'), 'alex',  'Alex',  'Cohen',     1, 'Tel Aviv',      '0501234567', '$2b$12$abcdefghijklmnopqrstuvwxyz'),
(UNHEX('112233445566778899AABBCC00000003'), 'maria', 'Maria', 'Levi',      2, 'Haifa',         '0529876543', '$2b$12$abcdefghijklmnopqrstuvwxyz'),
(UNHEX('112233445566778899AABBCC00000004'), 'dan',   'Dan',   'Rosen',     1, 'Rishon LeZion', '0541122334', '$2b$12$abcdefghijklmnopqrstuvwxyz'),
(UNHEX('112233445566778899AABBCC00000005'), 'sarah', 'Sarah', 'Goldman',   2, 'Netanya',       '0534455667', '$2b$12$abcdefghijklmnopqrstuvwxyz'),
(UNHEX('112233445566778899AABBCC00000006'), 'yossi', 'Yossi', 'Ben-David', 1, 'Ashdod',        '0509988776', '$2b$12$abcdefghijklmnopqrstuvwxyz')
ON DUPLICATE KEY UPDATE id=id;

-- Vets
INSERT INTO users (id, user_name, first_name, last_name, gender, city, telephone, password_hash) VALUES
(UNHEX('112233445566778899AABBCC10000001'), 'dr_amy',   'Amy',   'Stone',   2, 'Tel Aviv',  '0553334444', '$2b$12$abcdefghijklmnopqrstuvwxyz'),
...
(UNHEX('112233445566778899AABBCC00000001'), 1), -- vad       → customer
(UNHEX('112233445566778899AABBCC00000002'), 1), -- alex      → customer
(UNHEX('112233445566778899AABBCC00000003'), 1), -- maria     → customer
(UNHEX('112233445566778899AABBCC00000004'), 1), -- dan       → customer
(UNHEX('112233445566778899AABBCC00000005'), 1), -- sarah     → customer
